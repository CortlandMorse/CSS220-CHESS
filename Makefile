...
chess: main.o Board.o Chess.o CreatePiece.o King.o Queen.o Rook.o Bishop.o Knight.o Pawn.o
	$(CC) -o chess main.o Board.o Chess.o CreatePiece.o King.o Queen.o Rook.o Bishop.o Knight.o Pawn.o $(CFLAGS)
